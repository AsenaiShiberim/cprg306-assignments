...
return(
    <div className="flex justify-center w-full text-center  flex-col items-start" >
        <h1></h1>
        <form onSubmit={handleSubmit} className="p-2 m-4 border-transparent p-2 rounded-1g focus:border-transparent focus:ring-0 text-black max-w-sm w-full">
        <label className="text-black p-6">
            
            <input type="text"
            value={name} 
            placeholder="Enter item name"
            className="mt-1 border-2border rounded text-black"
